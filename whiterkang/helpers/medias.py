        ...
        buttons += [
            [
                InlineKeyboardButton(
                    "⭐️ BEST - 📹 MP4",
                    callback_data=f"yt_dl|{yt_id}|mp4|{user_id}|v|{chat_id}",
                ),
            ]
        ]
    if aud:
        best_audio_btn = [
            [
                InlineKeyboardButton(
                    "⭐️ BEST - 🎵 320Kbps - MP3",
                    callback_data=f"yt_dl|{yt_id}|mp3|{user_id}|a|{chat_id}",
                )
            ]
        ]
            ...
            for frmt in qual_list:
                ...
                if len(frmt_dict) != 0:
                    ...
                    video_btns.append(
                        InlineKeyboardButton(
                            f"📹 {frmt} ({frmt_size})",
                            callback_data=f"yt_dl|{yt_id}|{frmt_id}+140|{user_id}|v|{chat_id}",
                        )
                    )
                ...
                list(
                    map(
                        lambda x: InlineKeyboardButton(
                            audio_dict[x], callback_data=f"yt_dl|{yt_id}|{x}|{user_id}|a|{chat_id}"
                        ),
