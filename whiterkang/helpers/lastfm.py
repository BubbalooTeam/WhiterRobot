...
def draw_scrobble(
    ...
    loved: bool):
        ...
        draw.rectangle((248, 220, 248 + bar_width, 240), fill=bar_color, outline=None, width=0, radius=10)
        progress_width = round(bar_width * current_time / duration)
        draw.rectangle((248, 220, 248 + progress_width, 240), fill=progress_color, outline=None, width=0, radius=10)
