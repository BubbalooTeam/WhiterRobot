...
def draw_scrobble(
    ...
    duration: int,
        ...
        draw.rounded_rectangle((248, 220, 248, 240), fill=bar_color, outline=None, width=0, radius=10)
        progress_width = round(bar_width * current_time / duration)
        draw.rounded_rectangle((248, 220, 248, 240), fill=progress_color, outline=None, width=0, radius=10)
